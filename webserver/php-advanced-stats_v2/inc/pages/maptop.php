				...
				<div class="table-responsive">
					<table class="sortable table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<?php
							...
							if($style == -1){
								if($track == -1){
									$sql = "SELECT `rank`, `name`, `auth`, `time`, `track`, `style`, `date` FROM `round` WHERE `map` LIKE '".$map."' ORDER BY `time` ASC LIMIT 25";
								}
								else{
									$sql = "SELECT `rank`, `name`, `auth`, `time`, `track`, `style`, `date` FROM `round` WHERE `map` LIKE '".$map."' AND `track` = '".$track."' ORDER BY `time` ASC LIMIT 25";
								}
							}
							else{
								if($track == -1){
									$sql = "SELECT `rank`, `name`, `auth`, `time`, `track`, `style`, `date` FROM `round` WHERE `map` LIKE '".$map."' AND `style` = '".$style."' ORDER BY `time` ASC LIMIT 25";
								}
								else{
									$sql = "SELECT `rank`, `name`, `auth`, `time`, `track`, `style`, `date` FROM `round` WHERE `map` LIKE '".$map."' AND `track` = '".$track."' AND `style` = '".$style."' ORDER BY `time` ASC LIMIT 25";
								}
							}
